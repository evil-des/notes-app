...
const MESSAGES = {
  en: {
    ...
    editor: {
      ...
      shareDisabled: 'Only you can see this note.',
      shareEnabled: 'Anyone with this link can read this note.',
      shareEnable: 'Create link',
      shareUrl: 'Public note URL',
      shareCopy: 'Copy',
      shareCopied: 'Copied',
      shareCopyFailed: 'Could not copy',
      shareRevoke: 'Revoke',
    },
    shared: {
      loading: 'Loading note...',
      unavailableTitle: 'Note unavailable',
      notFound: 'This public note link is missing or no longer active.',
      date: 'Date',
      updated: 'Updated',
      empty: '_This note is empty._',
    },
    calendar: {
      today: 'Today',
      notesOn: 'Notes on',
  ...
  ru: {
    ...
    editor: {
      ...
      shareDisabled: 'Эту заметку видите только вы.',
      shareEnabled: 'Любой с этой ссылкой может читать заметку.',
      shareEnable: 'Создать ссылку',
      shareUrl: 'Публичная ссылка на заметку',
    ...
    shared: {
      ...
      unavailableTitle: 'Заметка недоступна',
      notFound: 'Эта публичная ссылка отсутствует или больше не активна.',
      date: 'Дата',
      updated: 'Обновлено',
      empty: '_Эта заметка пустая._',
    },
    calendar: {
      today: 'Сегодня',
      notesOn: 'Заметки на',
